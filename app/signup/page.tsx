        ...
        <div className="w-full border border-line bg-surface p-6">
          ...
          <form onSubmit={onSubmit} className="mt-6 flex flex-col gap-4">
            <div>
              ...
              <input id="name" type="text" value={name} onChange={(e) => setName(e.target.value)} placeholder="Your name" className="mt-1 w-full border border-line bg-bg-elevated px-2 py-2 font-mono text-sm text-ink outline-none focus:border-accent" />
            </div>
            <div>
            ...
            <button type="submit" className="btn-press border border-accent bg-accent px-4 py-3 text-accent-ink hover:bg-accent/90"><span className="label-caps uppercase">Create &amp; Continue</span></button>
          </form>
